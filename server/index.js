...
app.get('/api/monster', (req,res,next)=>{console.log('hit'); next()},controller.monster);
...
app.post('/api/endings/total_points', (req,res,next)=>{console.log('hit'); next()}, controller.totalPoints)
